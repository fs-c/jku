...
/**
 * A thread-safe barbecue implementation that uses a Semaphore. 
 ...
 */
public class SemaphoreOrderedGrill extends ChaoticGrill {
		
	public SemaphoreOrderedGrill(Participant firstParticipant) {

...
\usepackage{verbatim} % just for comment
\usepackage{csquotes}
...
% Custom minted environment with fixed options but parameterizable language
\newenvironment{simplecode}[1][js]%
  {\minted[linenos=false, frame=none, autogobble]{#1}}%
  {\endminted}
...
\title{Extractors for ECMAScript in GraalJS}
...
\author{Laurenz~Weixlbaumer\matno{11804751}}
...
\supervisor{\prefix{Dipl.-Ing.} Florian~Huemer, BSc}

%% Command \assistantsupervisor{name}: sets the name of the assistant supervisor(s)
\assistantsupervisor{\prefix{Dipl.-Ing.} Andreas~W\"o\ss{} (Oracle)}
...
\submissiondepartment{Institute for System Software}
...
\import{./chapters/}{01-introduction}
\import{./chapters/}{02-background}
\import{./chapters/}{03-extractors}
\import{./chapters/}{04-implementation}
\import{./chapters/}{05-evaluation}
\import{./chapters/}{06-related-work}
\import{./chapters/}{09-conclusion}

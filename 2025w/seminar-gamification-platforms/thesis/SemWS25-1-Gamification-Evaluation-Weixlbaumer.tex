...
\paragraph{Results} This leaves us with 21 open source frameworks for further evaluation, in the following referred to by either their reference or their short name, as listed in \fref{tab:open-source-frameworks}.
...
See \fref{tab:gamification-features-eval}, \fref{tab:technical-and-architectural-characteristics-eval}, \fref{fig:commits-over-time}.
...
\begin{figure}[p]
    ...
    \caption{Number of commits over time for the evaluated frameworks, as per \fref{sec:development-activity-and-stability}. Data taken from the respective repository's default branch. Note the different scales of the y-axes.\label{fig:commits-over-time}\vspace{.5em}}

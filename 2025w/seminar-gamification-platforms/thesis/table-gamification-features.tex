\begin{landscape}
    \begin{table}[p]
        ...
        \caption{Evaluation matrix of \emph{Gamification Features} as described in \fref{sec:gamification-features}. Each cell can have one of four values: \reqna{} = not applicable, \reqno{} = not supported, \reqpartial{} = partially supported, \reqyes{} = fully supported; see the respective sections for clarifications on the criteria for each evaluation.\label{tab:gamification-features-eval}}

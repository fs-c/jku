...
public class ScannerTest extends CompilerTestCaseSupport {
  ...
  @Test
  public void expFollowedByAssign() {
    initScanner("**=" + LF);
    expectToken(exp, 1, 1);
    expectToken(assign, 1, 3);
    scanAndVerify();
  }

  @Test
  public void expComments() {
    initScanner("**/********/**" + LF);
    expectToken(exp, 1, 1);
    expectToken(exp, 1, 13);
    scanAndVerify();
  }
}
